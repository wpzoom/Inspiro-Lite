									...
									<h4>
										<svg id="Icons" style="enable-background:new 0 0 32 32;" width="26" height="26"
											...
											<line class="st0" x1="25" x2="25" y1="30"
												  y2="25"/></svg> <?php esc_html_e( 'Site Logo', 'inspiro' ); ?>
									</h4>
									<p class="about">
						...
						<div class="theme-info-wrap">
							...
							<div class="wpz-grid-wrap">
								...
								<div class="section premium-feature">
									...
									<p class="section_footer">
										<a href="<?php echo esc_url( __( 'https://demo.wpzoom.com/inspiro-demo', 'inspiro' ) ); ?>"
										   target="_blank" class="button button-primary">
											<?php esc_html_e( 'Inspiro Premium Demos &rarr;', 'inspiro' ); ?>
										</a>

										<a href="<?php echo esc_url( __( 'https://demo.wpzoom.com/inspiro-pro-demo', 'inspiro' ) ); ?>"
										   target="_blank" class="button button-primary">
					...
					<div class="wpz-onboard_content-side-section discover-premium inspiro-block-version">
						...
						<div class="wpz-onboard_content-side-section-button">
							<a href="<?php echo esc_url( admin_url( 'theme-install.php?search=inspiro%2Bblocks' ) ); ?>"
							   ...
							   class="button"><?php esc_html_e( 'Install Now', 'inspiro' ); ?> &nbsp;<svg
					...
					<div class="wpz-onboard_content-side-section">
						...
						<div class="wpz-onboard_content-side-section-button">
							<a href="https://www.wpzoom.com/documentation/inspiro-lite/" title="Read documentation"
							   target="_blank" class="button"><?php esc_html_e( 'Documentation', 'inspiro' ); ?></a> <a
								href="https://wordpress.org/support/theme/inspiro/" title="Open Support Desk"
								target="_blank" class="button"><?php esc_html_e( 'Support Forums', 'inspiro' ); ?></a>
