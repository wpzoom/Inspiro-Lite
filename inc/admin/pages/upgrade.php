                        ...
                        <div class="wpz-onboard_content-side-section block-premium">
                            ...
                            <div class="section-image">
                                <a title="Inspiro Premium" target="_blank">
                                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/admin/inspiro-install-premium.png' ); ?>"
                        ...
                        <div class="theme-info-wrap">
                            <div class="wpz-grid-wrap">
                                ...
                                <div class="section quick-action-section">
                                    <div class="section-content">
                                        ...
                                        <?php esc_html_e( 'If you have purchased the Premium or PRO version of the theme, please download it as a ZIP file from the Members Area and upload it here.', 'inspiro' ); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="about-quick-links">
                                    <a class="description-link" href="https://www.wpzoom.com/docs/theme-installation/" target="_blank">
                                    ...
                                    <a class="description-link" href="https://www.wpzoom.com/docs/how-to-activate-the-license-key-of-your-wpzoom-theme/" target="_blank">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a class="description-link" href="https://www.wpzoom.com/documentation/inspiro-pro/how-to-migrate-from-inspiro-classic-to-inspiro-pro/" target="_blank">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
