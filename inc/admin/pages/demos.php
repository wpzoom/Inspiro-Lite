<div id="demos" class="wpz-onboard_content-main-tab wpz-onboard_content-main-theme-child demos wpz-onboard_content-side">
    ...
    <div class="theme-info-wrap">
        <h3 class="wpz-onboard_content-main-title"><?php esc_html_e( 'Inspiro Premium • 19', 'inspiro' ); ?></h3>
        <div class="theme-buttons">
            <a class="button button-themes">
                <?php esc_html_e( 'All Themes', 'inspiro' ); ?>
            </a>
            <a class="button button-common">
    ...
    <div class="theme-info-wrap">
        ...
        <h3 class="wpz-onboard_content-main-title"><?php esc_html_e( 'Inspiro Pro • 11', 'inspiro' ); ?></h3>
        <div class="theme-buttons">
            <a class="button button-themes">
                <?php esc_html_e( 'All Themes', 'inspiro' ); ?>
            </a>
