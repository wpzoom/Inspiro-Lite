                ...
                <div class="wpz-onboard_content-wrapper">
                    <div class="wpz-onboard_content">
                        ...
                        <div class="wpz-onboard_content-main">
                            <div id="quick-start" class="wpz-onboard_content-main-tab wpz-onboard_content-main-quickstart">
                                ...
                                <div class="theme-info-wrap welcome-section">
                                    ...
                                    <div class="theme-info-wrap">
                                        ...
                                        <h3 class="wpz-onboard_content-main-title">Customize & Configure</h3>

                                            <div class="wpz-grid-wrap">

                                                <div class="section">
                                                    <h4>
                                                        <svg viewBox="0 0 32 32" width="26" height="26" xmlns="http://www.w3.org/2000/svg"><title/><g data-name="add, picture, images, gallery, selection, album, portfolio" id="add_picture_images_gallery_selection_album_portfolio"><path d="M29,6H3A1,1,0,0,0,2,7V25a1,1,0,0,0,1,1H29a1,1,0,0,0,1-1V7A1,1,0,0,0,29,6ZM28,24H4V8H28Z"/><path d="M7,22H25a1,1,0,0,0,.77-1.64l-5-6a1,1,0,0,0-.72-.36,1,1,0,0,0-.76.29l-1.13,1.14-3.33-5A1,1,0,0,0,14,10a1.07,1.07,0,0,0-.83.43l-7,10a1,1,0,0,0-.07,1A1,1,0,0,0,7,22Zm7-9.23,3.19,4.78a1,1,0,0,0,1.54.16l1.22-1.23L22.86,20H8.92Z"/><path d="M23,12h2a1,1,0,0,0,0-2H23a1,1,0,0,0,0,2Z"/></g></svg> <?php esc_html_e( 'Homepage Hero Area', 'inspiro' ); ?>
                                                    </h4>
                                                    <p class="about">
                                        ...
                                        <h3 class="wpz-onboard_content-main-title"><svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M15 5.75C11.5482 5.75 8.75 8.54822 8.75 12C8.75 15.4518 11.5482 18.25 15 18.25C15.9599 18.25 16.8674 18.0341 17.6782 17.6489C18.0523 17.4712 18.4997 17.6304 18.6774 18.0045C18.8552 18.3787 18.696 18.8261 18.3218 19.0038C17.3141 19.4825 16.1873 19.75 15 19.75C10.7198 19.75 7.25 16.2802 7.25 12C7.25 7.71979 10.7198 4.25 15 4.25C19.2802 4.25 22.75 7.71979 22.75 12C22.75 12.7682 22.638 13.5115 22.429 14.2139C22.3108 14.6109 21.8932 14.837 21.4962 14.7188C21.0992 14.6007 20.8731 14.1831 20.9913 13.7861C21.1594 13.221 21.25 12.6218 21.25 12C21.25 8.54822 18.4518 5.75 15 5.75Z" fill="black" fill-rule="evenodd"/><path clip-rule="evenodd" d="M5.25 5C5.25 4.58579 5.58579 4.25 6 4.25H15C15.4142 4.25 15.75 4.58579 15.75 5C15.75 5.41421 15.4142 5.75 15 5.75H6C5.58579 5.75 5.25 5.41421 5.25 5Z" fill="black" fill-rule="evenodd"/><path clip-rule="evenodd" d="M4.75 8.5C4.75 8.08579 5.08579 7.75 5.5 7.75H8.5C8.91421 7.75 9.25 8.08579 9.25 8.5C9.25 8.91421 8.91421 9.25 8.5 9.25H5.5C5.08579 9.25 4.75 8.91421 4.75 8.5Z" fill="black" fill-rule="evenodd"/><path clip-rule="evenodd" d="M1.25 8.5C1.25 8.08579 1.58579 7.75 2 7.75H3.5C3.91421 7.75 4.25 8.08579 4.25 8.5C4.25 8.91421 3.91421 9.25 3.5 9.25H2C1.58579 9.25 1.25 8.91421 1.25 8.5Z" fill="black" fill-rule="evenodd"/><path clip-rule="evenodd" d="M3.25 12.5C3.25 12.0858 3.58579 11.75 4 11.75H8C8.41421 11.75 8.75 12.0858 8.75 12.5C8.75 12.9142 8.41421 13.25 8 13.25H4C3.58579 13.25 3.25 12.9142 3.25 12.5Z" fill="black" fill-rule="evenodd"/><path clip-rule="evenodd" d="M12.376 8.58397C12.5151 8.37533 12.7492 8.25 13 8.25H17C17.2508 8.25 17.4849 8.37533 17.624 8.58397L19.624 11.584C19.792 11.8359 19.792 12.1641 19.624 12.416L17.624 15.416C17.4849 15.6247 17.2508 15.75 17 15.75H13C12.7492 15.75 12.5151 15.6247 12.376 15.416L10.376 12.416C10.208 12.1641 10.208 11.8359 10.376 11.584L12.376 8.58397ZM13.4014 9.75L11.9014 12L13.4014 14.25H16.5986L18.0986 12L16.5986 9.75H13.4014Z" fill="black" fill-rule="evenodd"/></svg> Premium Features</h3>
                                            ...
                                            <div class="wpz-grid-wrap">
                                                ...
                                                <div class="section premium-feature">
                                                    ...
                                                    <p class="about">
                                                        <?php esc_html_e( 'Inspiro Premium is perfect for showing off your portfolio, images and videos. The theme includes multiple page templates to display your Portfolio posts and a custom Elementor Portfolio widget.', 'inspiro' ); ?>
                                                    </p>
                                                    <p class="section_footer">
                                                ...
                                                <div class="section premium-feature">
                                                    ...
                                                    <p class="about">
                                                        <?php esc_html_e( 'Need to sell something? With the Inspiro theme, you can build your shop and start selling anything easily! The theme is fully compatible with the WooCommerce plugin.', 'inspiro' ); ?>
                                                    </p>
                                                </div>


                                                <div class="section premium-feature">
                                                    <h4><svg height="26" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="26" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="_x31_09-elementor"><g><path d="M462.999,26.001H49c-12.731,0-22.998,10.268-22.998,23v413.998c0,12.732,10.267,23,22.998,23    h413.999c12.732,0,22.999-10.268,22.999-23V49.001C485.998,36.269,475.731,26.001,462.999,26.001" style="fill:#D63362;"/><rect height="204.329" style="fill:#FFFFFF;" width="40.865" x="153.836" y="153.836"/><rect height="40.866" style="fill:#FFFFFF;" width="122.7" x="235.566" y="317.299"/><rect height="40.865" style="fill:#FFFFFF;" width="122.7" x="235.566" y="235.566"/><rect height="40.865" style="fill:#FFFFFF;" width="122.7" x="235.566" y="153.733"/></g></g><g id="Layer_1"/></svg> <?php esc_html_e( 'Custom Elementor Modules', 'inspiro' ); ?>
                                                    </h4>
                                                    <p class="about">
                                                ...
                                                <div class="section premium-feature">
                                                    ...
                                                    <p class="about">
                                                        <?php esc_html_e( 'Inspiro Premium includes 6 Header Styles and 9 Footer Layouts.', 'inspiro' ); ?>
                                                    </p>
                                                ...
                                                <div class="section premium-feature">
                                                      ...
                                                      <h4><svg width="20" height="20" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M34 0H14C12.4087 0 10.8826 0.632141 9.75736 1.75736C8.63214 2.88258 8 4.4087 8 6V8H6C4.4087 8 2.88258 8.63214 1.75736 9.75736C0.632141 10.8826 0 12.4087 0 14V34C0 35.5913 0.632141 37.1174 1.75736 38.2426C2.88258 39.3679 4.4087 40 6 40H26C27.5913 40 29.1174 39.3679 30.2426 38.2426C31.3679 37.1174 32 35.5913 32 34V32H34C35.5913 32 37.1174 31.3679 38.2426 30.2426C39.3679 29.1174 40 27.5913 40 26V6C40 4.4087 39.3679 2.88258 38.2426 1.75736C37.1174 0.632141 35.5913 0 34 0ZM28 34C28 34.5304 27.7893 35.0391 27.4142 35.4142C27.0391 35.7893 26.5304 36 26 36H6C5.46957 36 4.96086 35.7893 4.58579 35.4142C4.21071 35.0391 4 34.5304 4 34V20H28V34ZM28 16H4V14C4 13.4696 4.21071 12.9609 4.58579 12.5858C4.96086 12.2107 5.46957 12 6 12H26C26.5304 12 27.0391 12.2107 27.4142 12.5858C27.7893 12.9609 28 13.4696 28 14V16ZM36 26C36 26.5304 35.7893 27.0391 35.4142 27.4142C35.0391 27.7893 34.5304 28 34 28H32V14C31.9946 13.3177 31.8728 12.6413 31.64 12H36V26ZM36 8H12V6C12 5.46957 12.2107 4.96086 12.5858 4.58579C12.9609 4.21071 13.4696 4 14 4H34C34.5304 4 35.0391 4.21071 35.4142 4.58579C35.7893 4.96086 36 5.46957 36 6V8Z" fill="#242628"/>
                                                        </svg> <?php esc_html_e( '9 Starter Sites', 'inspiro' ); ?> </h4>
                                                        <p class="about">
                                                            <?php esc_html_e( 'Importing demo data (post, pages, images, etc.) is the quickest and easiest way to set up your new theme, and it allows you to simply edit everything instead of creating content and layouts from scratch.', 'inspiro' ); ?>
                                                        </p>
                                                        <p class="section_footer">
                                                            <a href="<?php echo esc_url( __( 'https://demo.wpzoom.com/?theme=inspiro-demo', 'inspiro' ) ); ?>" target="_blank" class="button button-primary">
                                                                <?php esc_html_e( 'View All Demos', 'inspiro' ); ?>
                                                            </a>
                                                        </p>
                                                </div>
                                            ...
                                            <span class="many-more">And many other premium features...</span>

                                    </div>

                            </div>

                            <div id="vs-pro" class="wpz-onboard_content-main-tab wpz-onboard_content-main-license">
                                ...
                                <div class="theme-comparison">
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><h3><?php esc_html_e( 'Custom Elementor Widgets', 'inspiro' ); ?></h3></td>
                                                        <td><span class="dashicons dashicons-no"></span></td>
                                                        <td><span class="dashicons dashicons-yes"></span></td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <ul>
                                                    <li class="design_eccentric" data-design-id="inspiro-pro-eccentric">
                                                        <figure title="Eccentric">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/flow-1/home-thumb.png')"><button type="button" class="button-select-template">Select</button></div>
                                                            <figcaption>
                                                                <h5>Eccentric</h5>
                                                    ...
                                                    <li class="design_offbeat" data-design-id="inspiro-pro-offbeat">
                                                        <figure title="Offbeat">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/flow-2/home-thumb.png')"><button type="button" class="button-select-template">Select</button></div>
                                                            <figcaption>
                                                                <h5>Offbeat</h5>
                                                    ...
                                                    <li class="design_agency" data-design-id="inspiro-pro-agency">
                                                        <figure title="Agency">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/agency/home-thumb.png')"><button type="button" class="button-select-template">Select</button></div>
                                                            <figcaption>
                                                                <h5>Agency</h5>
                                                    ...
                                                    <li class="design_agency-dark" data-design-id="inspiro-pro-agency-dark">
                                                        <figure title="Agency (Dark)">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/agency-dark/home-thumb.png')"><button type="button" class="button-select-template">Select</button></div>
                                                            <figcaption>
                                                                <h5>Agency (Dark)</h5>
                                                    ...
                                                    <li class="design_business" data-design-id="inspiro-pro-business">
                                                        <figure title="Business">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/business/home-thumb.png')"><button type="button" class="button-select-template">Select</button></div>
                                                            <figcaption>
                                                                <h5>Business</h5>
                                                    ...
                                                    <li class="design_shop" data-design-id="inspiro-pro-shop">
                                                        <figure title="Shop">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/shop/home-thumb.png')"><button type="button" class="button-select-template">Select</button></div>
                                                            <figcaption>
                                                                <h5>Shop</h5>
                                                    ...
                                                    <li class="design_real-estate" data-design-id="inspiro-pro-real-estate">
                                                        <figure title="Real Estate">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/real-estate/home-thumb.png')"><button type="button" class="button-select-template">Select</button></div>
                                                            <figcaption>
                                                                <h5>Real Estate</h5>
                                                    ...
                                                    <li class="design_charity" data-design-id="inspiro-pro-charity">
                                                        <figure title="Charity / NGO">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/charity/home-thumb.png')"><button type="button" class="button-select-template">Select</button></div>
                                                            <figcaption>
                                                                <h5>Charity / NGO</h5>
                                                    ...
                                                    <li class="design_fitness" data-design-id="inspiro-pro-fitness">
                                                        <figure title="Fitness / Gym">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/fitness/fitness-home-thumb.png')"><button type="button" class="button-select-template">View Demo</button></div>
                                                            <figcaption>
                                                                <h5>Fitness / Gym</h5>
                                                                <a href="#" class="delete-imported-demo-content" title="Delete imported demo content" data-design="fitness" data-wxr-url="https://www.wpzoom.com/downloads/xml/inspiro-pro-fitness.xml" data-wxr-type="remote"></a>
                                                                <p>
                                                    ...
                                                    <li class="design_winery" data-design-id="inspiro-pro-winery">
                                                        <figure title="Winery">
                                                            <div class="preview-thumbnail" style="background-image:url('https://wpzoom.s3.us-east-1.amazonaws.com/elementor/templates/assets/thumbs/inspiro-pro/winery/home-thumb.png')"><button type="button" class="button-select-template">Select</button></div>
                                                            <figcaption>
                                                                <h5>Winery</h5>
                        ...
                        <div class="wpz-onboard_content-side">
                            <div class="wpz-onboard_content-side-section">
                                ...
                                <p class="wpz-onboard_content-side-section-content">Documentation is the place where you’ll find the information needed to setup the theme quickly, and other details about theme-specific features. You can also get in touch with our team by contacting us through our website or using the Support Forum.</p>
                                <div class="wpz-onboard_content-side-section-button">
                                    <a href="https://www.wpzoom.com/documentation/inspiro-lite/" title="Read documentation" target="_blank" class="button">Documentation</a> <a href="https://wordpress.org/support/theme/inspiro/" title="Open Support Desk" target="_blank" class="button">Support Forums</a>
                            ...
                            <div class="wpz-onboard_content-side-section">
                                <h3 class="wpz-onboard_content-side-section-title icon-assist">
                                    ...
                                    </svg> Walkthrough Video</h3>
                                <p class="wpz-onboard_content-side-section-content">Below you can find a quick video tutorial that will guide you through configuring basic things in the theme after installing it. Please remember that this video was created in 2021, and since then, many things have improved in our theme.</p>
