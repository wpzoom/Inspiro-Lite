  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      scripts: {
        ...
        tasks: ['jshint', 'concat:buildJS', 'clean:minifiedJS', 'uglify'],
        options: {
          livereload: true
        }
      },
    ...
    concat: {
      ...
      buildJS: {
        src: [
          'assets/js/unminified/jquery-headroom.js',
          'assets/js/unminified/headroom.js',
          'assets/js/unminified/superfish.js',
          'assets/js/unminified/navigation.js',
        ],
