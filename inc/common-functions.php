...
function inspiro_custom_logo() {
    has_custom_logo() ? the_custom_logo() : printf( '<a href="%s" title="%s" class="custom-logo-link">%s</a>', home_url(), get_bloginfo( 'description' ), get_theme_mod( 'custom_logo_text', get_bloginfo( 'name' ) ) );
}
